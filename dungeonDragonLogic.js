...
heart1.style.left = (gameWidth - 280) + "px";
const heart2 = document.getElementById("heart2");
heart2.style.left = (gameWidth - 200) + "px";
const heart3 = document.getElementById("heart3");
heart3.style.left = (gameWidth - 120) + "px";
const dragonImg = document.getElementById("dragon");
dragonImg.style.top = gameHeight / 2 + "px";
dragonImg.style.left = gameWidth * (1/4) + "px";
dragonImg.style.transform = "translate(-40%, -40%)";
const dragonHitImg = document.getElementById("dragonHit");
dragonHitImg.style.display = "none";
dragonHitImg.style.top = gameHeight / 2 + "px";
dragonHitImg.style.left = gameWidth * (1/4) + "px";
dragonHitImg.style.transform = "translate(-40%, -40%)";
...
portal.style.top = gameHeight / 2 + "px";
portal.style.left = gameWidth / 2 + 300 + "px";
portal.style.transform = "translate(-40%, -40%)";
...
function createFireballs2() {
    fireball12HB = { x: gameWidth * (1/4), y: gameHeight / 2 };
    fireball22HB = { x: gameWidth * (1/4), y: gameHeight / 2 };
    fireball32HB = { x: gameWidth * (1/4), y: gameHeight / 2 };
    fireball42HB = { x: gameWidth * (1/4), y: gameHeight / 2 };
    fireball52HB = { x: gameWidth * (1/4), y: gameHeight / 2 };
    fireball62HB = { x: gameWidth * (1/4), y: gameHeight / 2 };
...
function createFireballs() {
    fireball1HB = { x: gameWidth * (1/4), y: gameHeight / 2 };
    fireball2HB = { x: gameWidth * (1/4), y: gameHeight / 2 };
    fireball3HB = { x: gameWidth * (1/4), y: gameHeight / 2 };
    fireball4HB = { x: gameWidth * (1/4), y: gameHeight / 2 };
    fireball5HB = { x: gameWidth * (1/4), y: gameHeight / 2 };
    fireball6HB = { x: gameWidth * (1/4), y: gameHeight / 2 };
...
function createHomingFireball() {
    homingFireballsHB = {  x: gameWidth * (1/4), y: gameHeight / 2  }
...
function index() {
    if (x >= gameWidth / 2 + 100 && x <= gameWidth / 2 + 200 && y <= 30) {
