...
function wall2() {
    if (x + 60 >= 260 && x + 60 <= 320 && y + 60 >= gameHeight - 310 && y <= gameHeight) {
        keys["d"] = false;
    }
    if (x <= 350 && x >= 330 && y + 60 >= gameHeight - 310 && y <= gameHeight) {
        keys["a"] = false;
    }
    if (y + 60 >= gameHeight - 350 && y + 60 <= gameHeight - 290 && x + 60 >= 300 && x <= 350) {
        keys["s"] = false;
    }
    if (y <= gameHeight && y >= gameHeight - 20 && x + 60 >= 300 && x <= 350) {
        keys["w"] = false;
    }
}
