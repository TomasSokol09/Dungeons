...
function wall1() {
    ...
    if (x <= gameWidth*0.2 && x >= gameWidth*0.19 && y + 60 >= 0 && y <= gameHeight*0.38) {
        keys["a"] = false;
    }
...
function wall2() {
    ...
    if (x <= gameWidth*0.2 && x >= gameWidth*0.19 && y + 60 >= gameHeight*0.61 && y <= gameHeight) {
        keys["a"] = false;
    }
...
function goldenDoorOpening() {
    if (x <= gameWidth*0.2 && x >= gameWidth*0.19 && y >= 300 && y <= 500 && goldenKeyVariable){
        document.getElementById("unlockableDoor1").style.display = "none";
    }
}

function goldenDoorBorder() {
    if (x <= gameWidth*0.2 && x >= gameWidth*0.19 && y >= 300 && y <= 500) {
        keys["a"] = false;
    }
}
